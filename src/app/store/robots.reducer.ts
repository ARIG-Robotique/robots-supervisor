...
import { loadRobots, setMainRobot, setRobotStatus, toggleRobot } from './robots.actions';

const _robotsReducer = createReducer(
    [] as Robot[],
    on(loadRobots, (state, { robots }) => robots),
);

const _selectedRobotsReducer = createReducer(
    [] as { id: number; main: boolean }[],
...
const _robotsStatusReducer = createReducer(
